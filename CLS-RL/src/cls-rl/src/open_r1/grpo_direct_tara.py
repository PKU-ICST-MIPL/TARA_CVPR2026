...
from trainer import Qwen2VLGRPOTrainer_TARA, Qwen2VLGRPOVLLMTrainer
...
def main(script_args, training_args, model_args):
    ...
    Qwen2VLForConditionalGeneration.config_class.output_hidden_states = True
    
    trainer_cls = Qwen2VLGRPOTrainer_TARA if not training_args.use_vllm else Qwen2VLGRPOVLLMTrainer
