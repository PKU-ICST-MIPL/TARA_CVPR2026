...
import base64
import os
from transformers import Qwen2_5_VLForConditionalGeneration, Qwen3VLForConditionalGeneration, Qwen2VLForConditionalGeneration, AutoProcessor
...
def test_qwen(json_file, output_file, prompt_order, model_path):
    ...
    if "qwen2_5" in model_path.lower() or "qwen2.5" in model_path.lower():
